"""
Django settings for noisy_bonus_41472 project.
...
ROOT_URLCONF = 'noisy_bonus_41472.urls'
...
WSGI_APPLICATION = 'noisy_bonus_41472.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_bonus_41472 API",
    "DESCRIPTION": "API documentation for noisy_bonus_41472 App",
    "VERSION": "v1",
}
